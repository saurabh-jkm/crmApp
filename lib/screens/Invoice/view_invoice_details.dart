...
class viewInvoiceScreenn extends StatefulWidget {
  const viewInvoiceScreenn(
      {super.key, required this.header_name, required this.data});
  final String header_name;
  final Map data;
  @override
  State<viewInvoiceScreenn> createState() => _viewInvoiceScreennState();
}

class _viewInvoiceScreennState extends State<viewInvoiceScreenn> {
  var OrderData;
  bool isWait = true;
                ...
                child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        productRow(
                            context, "Mobile No.", "${OrderData["mobile"]}"),
                        productRow(
