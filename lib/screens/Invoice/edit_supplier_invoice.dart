...
class editSuplierInvoice extends StatefulWidget {
  final data;
  const editSuplierInvoice({super.key, this.data, required this.header_name});
  final String header_name;

  @override
  State<editSuplierInvoice> createState() => _editSuplierInvoiceState();
}
...
class _editSuplierInvoiceState extends State<editSuplierInvoice> {
  ...
  initList() async {
    await controller.init_functions(dbData: widget.data, type: 'buy');
                                                            ...
                                                            children: [
                                                              Container(
                                                                ...
                                                                child: autoCompleteFormInput(
                                                                    ...
                                                                    padding:
                                                                        8.0,
                                                                    isPreloadInput: (controller.totalIdentifire[i] !=
                                                                                null &&
                                                                            controller.totalIdentifire[i] ==
                                                                                true)
                                                                        ? true
                                                                        : false),
                                                              ),
