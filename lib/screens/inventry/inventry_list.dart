...
import 'package:jkm_crm_admin/screens/inventry/qr_code.dart';
...
////////   List       ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
                    ...
                    for (var index = 0; index < StoreDocs.length; index++)
                      (Responsive.isMobile(context))
                          ? tableRowWidget_mobile(
                              ...
                              "${StoreDocs[index]["category"]}",
                              "${StoreDocs[index]["status"]}",
                              "${StoreDocs[index]["no_item"]}",
                            )
                          : tableRowWidget(
                              "${index + 1}",
                              "${StoreDocs[index]["name"]}",
  ...
  Widget RowFor_Mobile_web(
      BuildContext context, label, descSell, colorrSell, descBuy, colorrBuy) {
    return Padding(
